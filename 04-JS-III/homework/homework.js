...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  for (var i = 0; i < arguments.length; i++) {
    a= a * arguments[i];
    //console.log(arguments, a); para verificar cada paso del bucle
...
function mayorACien(array) {
  ...
  // Tu código:
  var otroArray=[], indice=0;
  for (var i = 0; i < array.length; i++) {
    if (array[i] > 100){
      otroArray[indice++]=array[i];
...
function breakStatement(numero) {
  ...
  for (var i = 0; i < 10; i++) {
    ...
    if (numero === i){
      console.log("Se interrunpio la ejecucion")
      break;
    }
  }
  return array;
